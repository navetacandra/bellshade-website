...
function App() {
  ...
  const JavaPage = {
    ...
    Basic: {
      ...
      StrukturKontrolSwitchCase: lazy(() => import("./pages/java/basic/008_StrukturKontrolSwitchCase")),
    }
  }
      ...
      <BrowserRouter>
        <Suspense>
          <Routes>
            ...
            <Route path="/java/basic/pengkondisian-switch-case" element={<JavaPage.Basic.StrukturKontrolSwitchCase />} />
            {/* End Java Route */}
